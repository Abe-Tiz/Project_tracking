...
class AuditFormatter(logging.Formatter):
    """Custom formatter for audit logs with JSON support"""
    def format(self, record):
        if hasattr(record, 'audit_data'):
            # If audit data exists, format as JSON
...
def configure_logging(app: Flask):
    ...
    try:
        ...
        app.logger.info(f"📄 Audit log file: {audit_log_file}")
    except Exception as e:
        print(f"⚠️  Could not create audit log file: {str(e)}")
